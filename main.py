...
#     def menu_celular(celular: Celular):
#         while True:
...
#                 if opcion == "1":
#                     celular.encender_apagar()
#                 elif opcion == "2":
#                     break
#                 else:
#                     print("Opción inválida")
                
#             elif not celular.desbloqueado:
#                 opcion = input("""
#                 CELULAR BLOQUEADO
...
#                 Aplicaciones disponibles: {list(celular.apps.keys())}
#                 Ingrese una opción: """)
...
#         print(f"\nAplicaciones disponibles: {list(self.apps.keys())}")
